...
import (
	...
	"github.com/SilverdewBaker/azure-kusto-go/kusto/ingest"
	"github.com/SilverdewBaker/azure-kusto-go/kusto/internal/frames"
	"github.com/SilverdewBaker/azure-kusto-go/kusto/unsafe"
...
func TestQueries(t *testing.T) {
	...
	tests := []struct {
		...
		{
			desc:  "Mgmt(regression github.com/SilverdewBaker/azure-kusto-go/issues/11): make sure we can retrieve .show databases, but we do not check the results at this time",
		...
		{
			desc:  "Mgmt(https://github.com/SilverdewBaker/azure-kusto-go/issues/55): transformations on mgmt queries",
		...
		{
			desc: "Mgmt(https://github.com/SilverdewBaker/azure-kusto-go/issues/55): transformations on mgmt queries - multiple tables",
